...
public class GrandExchangeLanguageMap {
    ...
    private static final GrandExchangeLanguageMap instance = new GrandExchangeLanguageMap("en_us");//TODO GrandExchange.cfg.locale
    private final Map<String, String> languageList = Maps.newHashMap();

    GrandExchangeLanguageMap(String locale) {
        InputStream inputstream = GrandExchangeLanguageMap.class.getResourceAsStream("/assets/grandexchange/lang/" + locale + ".lang");
    ...
    private static void inject(GrandExchangeLanguageMap inst, InputStream inputstream) {
    ...
    static GrandExchangeLanguageMap getInstance() {
        return instance;
    }
